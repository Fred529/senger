                        ...
                        try {
                            ...
                            if (curl_errno($ch)) {
                                ...
                                switch ($result) {
                                    ...
                                    case '-2':
                                        $get_sms_status = 'Invalid Account IP';
                                        break;

                                    case '-3':
                                        $get_sms_status = 'Invalid ANI Black List';
                                        break;
                                    ...
                                    case '-6':
                                        $get_sms_status = 'Database Down';
                                        break;

                                    case '-7':
                                        $get_sms_status = 'Inactive Account';
                                        break;

                                    case '-11':
                                        $get_sms_status = 'Account Is Expired';
                                        break;

                                    case '-12':
                                        $get_sms_status = 'SMS is Empty';
                                        break;

                                    case '-13':
                                        $get_sms_status = 'Invalid Sender With Connection';
                                        break;

                                    case '-14':
                                        $get_sms_status = 'SMS Sending Failed Try Again';
                                        break;

                                    case '-100':
                                        $get_sms_status = 'Other Error';
                                        break;

                                    case '-16':
                                        $get_sms_status = 'User Can Not Send With DLR';
                                        break;

                                    case '-18':
                                        $get_sms_status = 'Invalid ANI';
                                        break;

                                    case '-19':
                                        $get_sms_status = 'SMS ID is Exist';
                                        break;
                    ...
                    case 'SendPulse':
                        try {
                            ...
                            if (isset($get_data->result) && $get_data->result == 1) {
                                $get_sms_status = 'Delivered';
                            } elseif (isset($get_data->is_error) && $get_data->is_error == true) {
                                $get_sms_status = $get_data->message;
                            } else {
