...
class Campaigns extends SendCampaignSMS
{
    ...
    public function singleProcess()
    {
        ...
        collect($cutting_array)->chunk(10)->each(function ($lines) use (&$prepareForTemplateTag, $cost, &$total_unit, $sending_server, $coverage) {
        ...
        collect($insertData)->chunk(10)->each(function ($lines) use (&$prepareForTemplateTag, $cost, &$total_unit, $sending_server, $coverage) {
