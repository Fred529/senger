            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
                            <h2 class="fw-bolder mb-0"> {{ Auth::user()->customer->listsCount() != null ? \App\Library\Tool::format_number(Auth::user()->customer->listsCount()): 0 }}</h2>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="card">
                    <div class="card-header">
                        @if(Auth::user()->customer->activeSubscription() != null)
                        <div>
                            <h2 class="fw-bolder mb-0">{{ Auth::user()->customer->subscriberCounts() != null ? \App\Library\Tool::format_number(Auth::user()->customer->subscriberCounts()) : 0 }}</h2>
                            ...
                            <div class="col-6 border-end py-1">
                                ...
                                <h3 class="fw-bolder mb-0">
                                    @if(Auth::user()->customer->maxLists() != null)
                                        {{ (Auth::user()->customer->maxLists() == '∞' ) ? __('locale.labels.unlimited') : \App\Library\Tool::format_number(Auth::user()->customer->maxLists())}}</h3>
                                @else
                                    0
                                @endif
                            </div>
