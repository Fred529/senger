    ...
    public function handle(): int
    {
        ...
        foreach ($users as $user) {
            if ($user->customer->activeSubscription() !== null) {
                ...
                if ($subscription->getOption('subscription_warning') == 1 && $subscription->getOption('send_warning') == false) {
                ...
                if ($subscription->getOption('credit_warning') == 1 && $user->sms_unit != '-1' && $subscription->getOption('send_warning') == false) {
